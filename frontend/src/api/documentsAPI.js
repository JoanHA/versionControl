...
export const createControl = (data) =>
  axios.post(URI + "documents/control", data);

//Masive saved
export const saveMasive = (data) => axios.post(URI + "auxiliars/masive", data);

//Obtener el ultimo cambio de un documento
export const lastChanges = (code) =>
  axios.get(URI + `documents/lastchange/${code}`);

//Eliminar documento

export const deleteDocuments = (id) => axios.delete(URI + `documents/${id}`);
